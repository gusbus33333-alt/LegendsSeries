    ...
    <>
      ...
      <section className="relative min-h-[55vh] flex flex-col justify-between bg-ink overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pb-16 pt-16 w-full">
          ...
          <p className="text-white/90 text-base mt-3 max-w-xl">
      ...
      <section className="py-20 lg:py-28 bg-parchment">
        <div className="max-w-5xl mx-auto px-6 lg:px-10">
          ...
          <ScrollReveal>
            ...
            <p className="text-ink/80 text-base leading-relaxed max-w-3xl">
          ...
          <ScrollReveal delay={0.05}>
            <div className="bg-ink p-7 mb-14">
              ...
              <p className="text-white/50 text-xs mt-1">{followYourTeamPriceExVat} per person</p>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              ...
              className="text-white/75 hover:text-gold text-xs tracking-[0.15em] uppercase transition-colors"
            >
              Friday 27 Nov →
            </Link>
            <Link
